...
/*text add in */
/*"~\\itai_a417\\20465_Reloaded\\mReloaded14"*/
#define PATH_BASE   "..//"                         /* windows PATH_BASE */
#define EXT_BEFORE ".txt" 
...
#define BASE_CRIT_ERR "Critical Error,  terminating and Freeing Allocation"
#define BASE_NON_CRIT_ERR "NON CRITICAL %s at line %d || At: %s"
